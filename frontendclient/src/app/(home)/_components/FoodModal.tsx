const FoodModal = ({ selectedFood, quantity, setQuantity, totalPrice, addToCart, setShowFoodModal }: any) => (
    <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 z-50 flex justify-center items-center">
      <div className="bg-white p-6 rounded-lg shadow-lg w-96">
        ...
        <p className="text-xl font-semibold text-gray-900 mt-4">${selectedFood.price}</p>
